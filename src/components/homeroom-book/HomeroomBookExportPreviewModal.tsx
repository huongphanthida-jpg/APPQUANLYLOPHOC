...
export const HomeroomBookExportPreviewModal: React.FC<HomeroomBookExportPreviewModalProps> = ({
  ...
  const excelSheets = [
    ...
    { id: 5, name: '6. Nề Nếp & Thi Đua', icon: ShieldCheck, desc: 'Nhật ký khen thưởng, vi phạm & biểu đồ phân nhóm học lực' },
  ...
  const pdfPages = [
    ...
    { id: 6, title: 'Trang 6: Theo Dõi Nề Nếp Kỷ Luật & Thi Đua Lớp Học', section: 'Kỷ luật & Thi đua' },
...
export default HomeroomBookExportPreviewModal;
