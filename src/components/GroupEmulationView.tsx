            ...
            {(role === 'gvcn' || role === 'csl') && (
              <>
                ...
                <button
                  ...
                  className="px-3 py-2.5 rounded-xl bg-red-500/90 hover:bg-red-600 text-white font-bold text-xs shadow-md active:scale-95 transition-all flex items-center gap-1.5 cursor-pointer"
